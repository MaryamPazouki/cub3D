...
static int	is_valid_texture_path(t_game *game, const char *path)
{
	...
	{
		fprintf(stderr,
			"\033[31mError: Invalid texture extension for '%s'. Must be .xpm\033[0m\n",
			path);
		free_game(game);
	}
